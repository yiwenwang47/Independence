...
# These parameters come from experiments done on datasets with various n values.
# Therefore, there is no guarantee they make complete sense.  
...
# Please see above for specific parameters.
